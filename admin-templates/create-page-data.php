...
<form action=""
    ...
    <input type="hidden" name="currentModule" id="currentModule" value="<?php if (isset($moduleid)) {
        echo $moduleid;
    } ?>"/>
            ...
            <label>
                ...
                <select name="moduleName" id="selectboxdataid">
                    ...
                    <?php foreach ($moduleList as $module) { ?>
                        <option
                            value="<?= $module['id']; ?>" <?php if (isset($moduleid) && $moduleid == $module['id']) { ?> selected <?php } ?>><?= $module['name']; ?></option>
                    <?php } ?>
                </select>
            </label>
        </div>
    ...
    <div class="row">
        <hr/>
        <div class="large-12 columns"><label>Data Item Description <input type="text" name="pageName" placeholder=""/>
            </label></div>
    </div>
    <div class="row">
        <div class="large-12 columns">
            ...
            <table id="list-modules" class="tablesorter">
                ...
                <?php foreach ($moduleItems as $key => $item) {
                    ...
                    ?>
                    <tr>
                        <td class="text-center"><input type="checkbox" value="<?= $item['id']; ?>" name="dataItems[]"/>
